	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<h2 class="title">MemberDetail</h2>
						...
						<tbody>
							<c:forEach items="${mdList}" var="md">
								<tr>
									...
									<td>${md.address}</td>
									<td>${md.email}</td>
									<td><img src="${md.photo}" class="memberdetailpic"></td>

									<td><a href="DeleteMemberDetailByID.do?id=${md.id}"><button>
												<img src="Component/delete.png">
											</button></td>
									</a>
									<td><a href="GetMemberDetailPage.do?id=${md.id}"><button>
