			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="table-responsive">
					...
					<form action="Login.do" method="post">
						<fieldset>
							<div class="formgroup">
								<label class="t1">帳號：</label> <input type="text"
									placeholder="請輸入帳號(英文)" name="username" />
							</div>

							<div class="formgroup">
								<label class="t1">密碼：</label> <input type="password"
									placeholder="請輸入密碼(共4位數)" name="password" />
							</div>

							<div class="formgroup">
								<label class="t1">類別：</label> 
								<select name="isAdmin">
										<option>admin</option>
						...
						<div class="buttongroup">
							<input type="submit" value="登入" name="submit" /> <input
