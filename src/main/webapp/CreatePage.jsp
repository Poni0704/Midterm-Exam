	...
	<div class="container-fluid">
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<h2 class="title">Create BadmintonCourse</h2>
				<div class="table-responsive">
					...
					<form action="Create.do" method="post"
						...
						<fieldset>
							<div class="formgroup">
								<label class="t1">授課教師：</label> <input type="text" placeholder="ex：戴姿穎"
									name="pteacher" />
							</div>

							<div class="formgroup">
								<label class="t1">課程名稱：</label> <input type="text" placeholder="ex：羽球初階課程"
									name="pcontent" />
							</div>

							<div class="formgroup">
								<label class="t1">課程費用： </label> <input type="number" placeholder="ex：8000"
									name="price" />
							</div>

							<div class="formgroup">
								<label class="t1">師資照片： </label> <input type="file" name="photo" />
							</div>
						</fieldset>
